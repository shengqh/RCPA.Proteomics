...
{
  partial class SummaryBuilderUI
  {
    /// <summary>
    ...
    private void InitializeComponent()
    {
      ...
      this.pnlDataFiles = new System.Windows.Forms.SplitContainer();
      this.lvDatFiles = new System.Windows.Forms.ListView();
      this.lblDataFile = new System.Windows.Forms.Label();
      this.pnlTitleFormat = new System.Windows.Forms.Panel();
      this.cbTitleFormat = new System.Windows.Forms.ComboBox();
      this.cbAutoFindFormat = new System.Windows.Forms.CheckBox();
      this.label7 = new System.Windows.Forms.Label();
      this.btnFindFormat = new System.Windows.Forms.Button();
      ...
      this.pnlTitleFormat.SuspendLayout();
    ...
    "red";
      ...
      // datafileGroup
      // 
      this.datafileGroup.Controls.Add(this.pnlDataFiles);
      ...
      // pnlDataFiles
      // 
      this.pnlDataFiles.Dock = System.Windows.Forms.DockStyle.Fill;
      this.pnlDataFiles.FixedPanel = System.Windows.Forms.FixedPanel.Panel2;
      this.pnlDataFiles.IsSplitterFixed = true;
      this.pnlDataFiles.Location = new System.Drawing.Point(3, 3);
      this.pnlDataFiles.Name = "pnlDataFiles";
      // 
      // pnlDataFiles.Panel1
      // 
      this.pnlDataFiles.Panel1.Controls.Add(this.lvDatFiles);
      this.pnlDataFiles.Panel1.Controls.Add(this.lblDataFile);
      this.pnlDataFiles.Panel1.Controls.Add(this.pnlTitleFormat);
      // 
      // pnlDataFiles.Panel2
      // 
      ...
      this.lvDatFiles.SelectedIndexChanged += new System.EventHandler(this.lvDatFiles_SelectedIndexChanged);
      // 
      // lblDataFile
      // 
      ...
      // pnlTitleFormat
      // 
      this.pnlTitleFormat.Controls.Add(this.cbTitleFormat);
      ...
      // cbAutoFindFormat
      // 
      this.cbAutoFindFormat.AutoSize = true;
      ...
      this.btnFindFormat.Click += new System.EventHandler(this.btnFindFormat_Click);
      // 
      // databaseGroup
      // 
      ...
      this.pnlTitleFormat.ResumeLayout(false);
      this.pnlTitleFormat.PerformLayout();
    ...
    protected System.Windows.Forms.SplitContainer pnlDataFiles;
    protected System.Windows.Forms.ListView lvDatFiles;
    protected System.Windows.Forms.Label lblDataFile;
    private System.Windows.Forms.Panel pnlTitleFormat;
    private System.Windows.Forms.ComboBox cbTitleFormat;
    private System.Windows.Forms.Label label7;
    private System.Windows.Forms.Button btnFindFormat;
    private System.Windows.Forms.CheckBox cbAutoFindFormat;
