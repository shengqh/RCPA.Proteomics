...
{
  public class MascotSnpValidator2 : AbstractThreadFileProcessor
  {
    ...
    public MascotSnpValidator2(string mutationPattern, string fastaFile, IAccessNumberParser acParser, HashSet<int> charges, string pNovoPeptideFile)
    {
