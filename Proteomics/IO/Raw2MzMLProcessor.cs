...
{
  public class Raw2MzMLProcessor : AbstractThreadFileProcessor
  {
    ...
    public Raw2MzMLProcessor(RawFileImpl rawFile, bool fullMsOnly, bool doCentroid, string targetDirectoryName,
    ...
    {
      string outfilename = FileUtils.ChangeExtension(sourceFile.FullName, "mzML").Replace('\\', '/');

      /*
       * Write mzML start tag
       */
      sw.WriteLine("<?xml version=\"1.0\" encoding=\"ISO-8859-1\"?>");
      sw.WriteLine(
        "<indexedmzML xmlns=\"http://psi.hupo.org/schema_revision/mzML_1.1.0\" xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xsi:schemaLocation=\"http://psi.hupo.org/schema_revision/mzML_1.1.0 mzML1.1.0_idx.xsd\">");
      sw.WriteLine(
        "  <mzML xmlns=\"http://psidev.info/ms/mzML/xsd/mzML1.1.0\" accession=\"{0}\" id=\"urn:lsid:cn.ac.rcpa.Proteomics.IO.MzMLFormat\" version=\"{1}\">",
        outfilename, version);

      /* cv list */
      sw.WriteLine("    <cvList count=\"1\">");
      sw.WriteLine(
        "      <cv id=\"MS\" fullName=\"Proteomics Standards Initiative Mass Spectrometry Ontology\" version=\"1.12.0\" URI=\"http://psidev.cvs.sourceforge.net/*checkout*/psidev/psi/psi-ms/mzML/controlledVocabulary/psi-ms.obo\"/>");
      sw.WriteLine("    </cvList>");

      /*
       * Write file description block
       */
      sw.WriteLine("    <fileDescription>");
      sw.WriteLine("      <fileContent>");
      //writeNoValueCVParam(sw, "        ", "MS", "MS:1000580", "MSn spectrum");
      //writeNoValueCVParam(sw, "        ", "MS", "MS:1000776", "scan number only nativeID format");
      sw.WriteLine("      </fileContent>");
