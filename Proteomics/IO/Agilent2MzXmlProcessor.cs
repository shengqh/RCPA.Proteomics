...
//{
//  //public class Agilent2MzXmlProcessor : AbstractThreadFileProcessor
//  //{
...
//  //  private readonly AgilentDirectoryImpl rawFile;
//  //  private readonly bool saveToSourceDirectory;
//  //  private readonly DirectoryInfo targetDirectory;

//  //  public Agilent2MzXmlProcessor(AgilentDirectoryImpl rawFile, bool fullMsOnly, bool doCentroid, string targetDirectoryName,
...
//  //  public override IEnumerable<string> Process(string directory)
//  //  {
//  //    var sourceFile = new DirectoryInfo(directory);
//  //    if (!sourceFile.Exists)
//  //    {
//  //      throw new ArgumentException("Directory not exist : " + directory);
//  //    }
...
//  //    {
//  //      targetFilename = sourceFile.Parent.FullName + "\\" + targetFilename;
//  //    }
//  //    else
//  //    {
...
//  //      try
//  //      {
//  //        Progress.SetMessage("Opening directory " + sourceFile.FullName + "...");
//  //        this.rawFile.Open(directory);
...
//  //  private void WriteXmlHeader(StreamWriter sw, DirectoryInfo sourceFile, List<int> scans)
//  //  {
//  //    //xml header and namespace info 
//  //    sw.Write("<?xml version=\"1.0\" encoding=\"ISO-8859-1\"?>" + lf
//  //             + "<mzXML" + lf);
//  //    sw.Write(" xmlns=\"http://sashimi.sourceforge.net/schema_revision/mzXML_3.1\"" + lf
...
//  //    string instModel = this.rawFile.Reader.MSScanFileInformation.DeviceType.ToString();

//  //    sw.Write("  <msInstrument>" + lf
//  //             + "   <msManufacturer category=\"msManufacturer\" value=\"Agilent\"/>" + lf
//  //             + "   <msModel category=\"msModel\" value=\"AGILENT TOF\"/>" + lf
//  //             + "   <msIonisation category=\"msIonisation\" value=\"ESI\"/>" + lf
//  //             + "   <msMassAnalyzer category=\"msMassAnalyzer\" value=\"TOFMS\"/>" + lf
//  //             + "   <msDetector category=\"msDetector\" value=\"unknown\"/>" + lf);
