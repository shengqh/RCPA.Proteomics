...
{
  public class MascotPepXmlWriter
  {
    ...
    public MascotPepXmlWriter(string rawDataType)
    {
    ...
    public void WriteParameter(SequestParam sp)
    {
      if (!this.isMsmsRunSummaryOpened)
      {
    ...
    public void WriteSequestPeptideHit(IdentifiedSpectrum sph)
    {
      if (!this.isMsmsRunSummaryOpened)
      {
